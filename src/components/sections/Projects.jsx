                    ...
                    <FadeIn delay={0}>
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-md">
                                ...
                                <span className="text-sm text-gray-400 uppercase tracking-widest font-display font-medium">Stellar Fleet</span>
                            </div>
                            ...
                            <p className="text-gray-300 text-lg md:text-xl mb-8 font-light max-w-2xl mx-auto leading-relaxed">
                            ...
                            <div className="flex flex-wrap justify-center gap-3">
                                {category.map((cat) => (
                                    <button
                                        ...
                                        className={`px-5 py-2.5 rounded-full text-xs md:text-sm font-medium transition-all duration-300 cursor-pointer ${activeCategory === cat
